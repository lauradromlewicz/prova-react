    ...
    public class AppDataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Tarefa>().HasData(
                ...
                new Tarefa { TarefaId = "2f1b7dc1-3b9a-4e1a-a389-7f5d2f1c8f3e", Titulo = "Estudar Angular", Descricao = "Preparar-se para a aula de Angular", CriadoEm = DateTime.Now.AddDays(3), CategoriaId = "6d091456-5a2f-4b5a-98fc-f1a3b50a627d", Status = "Iniciada" },
                new Tarefa { TarefaId = "e5d4a7b9-1f9e-4c4a-ae3b-5b7c1a9d2e3f", Titulo = "Passeio no parque", Descricao = "Dar um passeio relaxante no parque", CriadoEm = DateTime.Now.AddDays(14), CategoriaId = "39be53a2-fc09-4b6a-bafa-18a6a23c8f6e", Status = "Finalizada" }
            );
        }
    }
}
